...
public static class NvmlWrapper
{
...
#if LINUX
    private const string NVML_LIB = "libnvidia-ml.so";
#elif WINDOWS
    private const string NVML_LIB = "nvml.dll";
#endif
    [DllImport(NVML_LIB)]
    ...
    [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetUtilizationRates(IntPtr device, out NvmlUtilization utilization); [DllImport(NVML_LIB)]
    ...
    [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetMemoryInfo(IntPtr device, out NvmlMemory memory); [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetPerformanceState(IntPtr device, out NvmlPStates pState);
    [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetClockInfo(IntPtr device, NvmlClockType type, out uint clock); [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetPowerManagementLimit(IntPtr device, out uint limit); [DllImport(NVML_LIB)]
    ...
    [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceSetFanControlPolicy(IntPtr device, uint fan, NvmlFanControlPolicy policy); [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetNumFans(IntPtr device, out uint numFans);
    [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetTargetFanSpeed(IntPtr device, uint fan, out uint targetSpeed); [DllImport(NVML_LIB)]
    public static extern NvmlReturnCode nvmlDeviceGetFanSpeed_v2(IntPtr device, uint fan, out uint speed); [DllImport(NVML_LIB)]
